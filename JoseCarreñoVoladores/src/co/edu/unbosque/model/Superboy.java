...
public class Superboy extends Superman {
	...
	public String halfHuman() {
		return "Soy hijo de un kriptoniano y una humana";
	}
	
	public String tactileTelekinesis() {
		return "Tengo una mini barrea telequinetica";
	}
}

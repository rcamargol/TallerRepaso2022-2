...
public class Kira extends Heroe{
	...
	@Override
	public String volar() {
		String msj = "Kira tiene la habilidad de volar, pero debe saber usarlo, el tiempo limite para la acci�n es "+super.tiempoVuelo+" minutos.";
		return msj;
	}
	...
	public String habitar() {
		String msj = "Kira al ser catalogada como H�ROE esta con los de su misma clase al norte del planeta.";
		return msj;
	}
	...
	public void generarExcepcionEstaturaKira() throws NoPareceEsoExeption {
		// Aqui se evalua si la estatura de Kira es menor o supera a la estatura normal de un h�roe  
		if (super.estatura < 3 || super.estatura > 3) {
			throw new NoPareceEsoExeption("parece ser que Kira no es una H�roe, su altura debe ser igual a 3 metros, y tiene "+super.estatura+" metros.");
		}
